...
c
      integer*2 lc2, ldiams, Linux,
     x          MacOS, mconvx, mdiff, mdim, mdim1, mdim2, mfiles,
     x          mLayer, mlimbs, mlist3, mlists,
     x          mplatn, mpts, mrve, mstack, Unix, Windows
c
...
c
c-----assign integers to the different operating systems
      parameter(Linux=0, Unix=1, MacOS=2, Windows=3)
